...
def users_groups(request, pk):
    ...
    return render(
        request, "back/users_groups.html", {"group": group, "ugroup": ugroup, "pk": pk}
    )
...
def users_perms(request, pk):
    ...
    perms = Permission.objects.all()
    return render(
        request, "back/users_perms.html", {"uperms": uperms, "perms": perms, "pk": pk}
    )
...
def groups_perms(request, name):
    ...
    return render(
        request,
        "back/groups_perms.html",
        {"perms": perms, "allperms": allperms, "name": name},
    )
